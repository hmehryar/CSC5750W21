...
<head>
  ...
  <title>Tickets Confirmation page, v5</title>
	<!-- Required meta tags -->
    <meta charset="utf-8">
...
<body>
  ...
  <div class="col-md-6">
        ...
        <table class="table table-sm table-hover table-responsive table-responsive-lg display"  style="width:100%" id="ticketsTable">
        <thead>
            <tr>
                <th>ID</th>
                <th>Name</th>
  ...
  <script src="https://code.jquery.com/jquery-3.5.1.js"></script>
    ...
    "use strict";
        ...
        $('#ticketsTable').DataTable( {
            "ajax": 'DatabaseInterface.php?Request=list',
            "columns": [
            { "data": "ID" },
            { "data": "Name" },
            { "data": "Event" },
